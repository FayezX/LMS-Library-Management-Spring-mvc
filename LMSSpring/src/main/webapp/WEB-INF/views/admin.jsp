        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="bookorauthor" class="portfolio-link">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminPublisher" class="portfolio-link">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminbranches" class="portfolio-link">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminBorrower" class="portfolio-link">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="adminOverride" class="portfolio-link" data-target="#override" data-toggle="modal">
                        <div class="portfolio-hover">
                            <div class="portfolio-hover-content">
                                <i class="fa fa-plus fa-3x"></i>
                            </div>
