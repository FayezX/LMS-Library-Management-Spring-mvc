  ...
  <ul class="pagination">
	...
	<table class = "table" rules="all">
		...
		<tr>
			...
			<button type = "button" class = "btn btn-link" data-toggle ="modal" data-target="#editcopy" href="librarianviewbranchcopies?branchId=${a.branchId}&bookId=${b.bookId}">${b.title}</button>			
			<br />
			<br />
			</gcit:forEach>
			...
			<td><button type = "button" class = "btn btn-primary btn-sm" data-toggle ="modal" data-target="#editBranchModal" href="editbranch?branchId=${a.branchId}">Update Branch</button></td>
		</tr>
		</gcit:forEach>
	</table>
            </div>
